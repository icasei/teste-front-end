...
import { Video, VideoCategory, VideoByCategory } from '../../../store/type';
...
const Content = (props: IContent) => {
    const grid = <VideoGrid videos={props.videos} title="Recomendaddos" showDivider />;
    ...
    return <InfiniteScroll callBack={onCallBack} isLoading={props.videosLoading}>
